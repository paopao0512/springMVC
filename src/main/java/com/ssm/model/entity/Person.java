...
public class Person {
    ...
    public Long getEnroiment_time() {
        return Enroiment_time;
    }

    public void setEnroiment_time(Long enroiment_time) {
        Enroiment_time = enroiment_time;
    }
    ...
    public void setDaily_conection(String daily_conection) {
        Daily_conection = daily_conection;
    }
    ...
    public Person(String name,String QQ, String iesson_type,
                  String Long_time, String Graduated_school, int student_ID, String Daily_conection,
    ...
    public Person(int id, String name, String QQ, String iesson_type,
                  Long Enroiment_time, String Graduated_school, int student_ID, String Daily_conection,
                  String wish, String brother_name, String Channel) {
        super();
        this.id = id;
        this.name = name;
