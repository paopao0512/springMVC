...
<body>
<form action="${pageContext.request.contextPath }/editItemsSubmit.action">
    <table width="100%" border=1>
        ...
        <tr>
            <td><input type="text" name="id" style="width: 30px;" value="${itemsList.id }"></td>
            ...
            <td>
                <input type="submit">
                <a href="${pageContext.request.contextPath } /deleteItem.action?id=${itemsList.id}">删除</a>
            </td>
        </tr>
        <%--</c:forEach>--%>
